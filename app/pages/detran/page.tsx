  ...
  Solicite seu orçamento
        ...
        <div className="max-w-4xl mx-auto text-center px-6 py-16">
          ...
          <p className="text-1xl md:text-xl mb-2">
            Resolva todas as pendências do seu veículo em um só lugar! Cuidamos de <strong>IPVA, GRT, multas, DUDA, CRLV, ATPV-e, vistoria e muito mais</strong> com agilidade, segurança e total suporte — evite complicações e deixe a parte burocrática com quem entende.
          </p>
