  ...
  Solicite seu orçamento
        ...
        <div className="max-w-4xl mx-auto text-center px-6 py-16">
          ...
          <p className="text-1xl md:text-xl mb-2">
            Emitimos 2ª via de documentos com agilidade e segurança — <strong>CPF, RG, CNH, certidões, título de eleitor e muito mais</strong> — para você resolver tudo em um só lugar, sem burocracia e com total confiança.
          </p>
