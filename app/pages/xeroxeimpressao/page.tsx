  ...
  Solicite seu orçamento
        ...
        <div className="max-w-4xl mx-auto text-center px-6 py-16">
          ...
          <p className="text-1xl md:text-xl mb-2">
            <strong>Xerox e impressões profissionais</strong> com qualidade impecável em qualquer papel ou gramatura — do sulfite ao fotográfico, adesivo ou certificado — garantindo cores vivas, definição nítida e um acabamento que transmite credibilidade em cada detalhe.
          </p>
      ...
      <section className=" py-20 px-6 bg-gradient-to-r from-[#002F73] via-[#003A8F] to-orange-600 text-white">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm pb-6">
