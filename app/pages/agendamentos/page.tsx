  ...
  Solicite seu orçamento
        ...
        <div className="max-w-4xl mx-auto text-center px-6 py-16">
          ...
          <p className="text-1xl md:text-xl mb-2">
            Agende seus serviços com rapidez e segurança, sem enfrentar filas ou perder tempo. <strong>Realizamos agendamentos para 2ª via de Identidade, CNH, Seguro-Desemprego, CadÚnico (CRAS), Receita Federal, INSS, Detran e muito mais</strong>, garantindo orientação completa em cada etapa. Resolva tudo com organização, agilidade e o suporte de quem entende dos procedimentos.
          </p>
