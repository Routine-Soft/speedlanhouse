    ...
    <section className="relative w-full text-white overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center px-6 py-16">
          ...
          <p className="text-1xl md:text-xl mb-2">
            Soluções rápidas para o seu dia a dia. Há 10 anos transformando problemas em solução.
          </p>
      ...
      {/* BENEFÍCIOS */}
      <section className="bg-gradient-to-r from-[#002F73] via-[#003A8F] to-orange-600 text-white py-4">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row justify-center gap-8 text-center font-medium">
          ...
          <div>✅ 100% Seguro</div>
          <div>✅ Faça sem sair de casa</div>
        </div>
      </section>

      {/* SERVIÇOS */}
      <section className="py-16 bg-gradient-to-r from-[#002F73] via-[#003A8F] to-orange-600 text-white">
          ...
          <div className="flex flex-col items-center gap-6">
              ...
              {[
                {
                  ...
                  desc: 'Preto e branco ou colorido, em diversos tipos de papel.',
                  link: '/pages/xeroxeimpressao',
                  icon: <Image src="/img/impressora1.png" alt="Xerox" width={150} height={40} />
                },
                {
                  title: '2a Via de Documentos',
                  desc: 'CPF, RG, CNH, certidões, título de eleitor e muito mais.',
                  link: '/pages/2aviadocumentacao',
                  icon: <Image src="/img/doc.png" alt="Xerox" width={200} height={40} />
                },
                {
                  title: 'Serviços DETRAN',
                  desc: 'IPVA, GRT, multas, DUDA, CRLV, ATPV-e, vistoria e muito mais.',
                  link: '/pages/detran',
                ...
                <Link
                  key={i}
                  href={service.link}
                  className="bg-white rounded-xl shadow-md p-6 text-center hover:shadow-xl hover:-translate-y-1 transition block cursor-pointer w-80"
                >
            ...
            <div className="flex flex-wrap justify-center gap-6">
              {[
                {
                  title: 'CONSULTAS',
                  desc: 'SPC, Serasa, CPF, CNPJ e muito mais.',
                  link: '/pages/consultas',
                  icon: <Image src="/img/serasa.png" alt="Xerox" width={200} height={40} />
                },
                {
                  title: 'Agendamentos',
                  desc: '2ª via de Identidade, CNH, Seguro-Desemprego, CadÚnico (CRAS), Receita Federal, INSS, Detran e muito mais.',
                  link: '/pages/agendamentos',
                  icon: <Image src="/img/agendamento.png" alt="Xerox" width={200} height={40} />
                },
                {
                  title: 'Digitação de Documentos',
                  desc: 'Currículos e contratos profissionais, estruturados conforme as exigências do mercado e redigidos com clareza e precisão.',
              ...
              {[
                {
                  ...
                  desc: 'Conheça todos os nossos serviços e tenha a praticidade de resolver tudo em um único lugar. ',
      ...
      {/* CONTATO */}
       <section className=" items-center bg-gradient-to-r from-[#002F73] via-[#003A8F] to-orange-600 text-white py-16">
      ...
      {/* FOOTER */}
      <footer className="bg-gradient-to-r from-[#002F73] via-[#003A8F] to-orange-600 text-white text-center py-6 text-sm text-gray-600">
